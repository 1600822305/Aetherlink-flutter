...
import 'package:aetherlink_flutter/features/chat/presentation/widgets/top_bar/toolbar_group.dart';
    ...
    switch (component) {
      ...
      case TopToolbarComponent.condenseButton:
        ...
        return ToolbarIconButton(
          ...
          onPressed: isStreaming ? null : () => openCondenseDialog(context),
        );
      case TopToolbarComponent.miniMapButton:
        return ToolbarIconButton(
          ...
          onPressed: () => openMiniMap(context, ref),
        );
