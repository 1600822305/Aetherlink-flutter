...
import 'package:aetherlink_flutter/app/di/chat_gateway_access.dart';
...
const String kDefaultSuggestionPrompt =
    '我会在 <content> 块中给你一段 User 与 AI 助手的对话。\n'
    '请你站在 User 的角度，生成 3 条贴合上下文、可继续对话的追问或回复。\n\n'
    '规则：\n'
    '1. 直接输出建议，每条独占一行，不要编号、不要项目符号、不要任何多余说明\n'
    '2. 使用与对话一致的语言\n'
    '3. 每条简洁有效，确实有助于继续对话\n'
    '4. 模仿 User 此前的语气；你是在扮演 User，而不是助手\n\n'
    '<content>\n{content}\n</content>';
...
const String kDefaultCompressPrompt =
    '''你是专业的对话上下文压缩助手。请将下方对话历史压缩为一段结构化、信息密度高的摘要，供后续对话作为上下文继续使用。
