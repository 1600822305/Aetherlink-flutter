...
const kGeminiVoices = <VoicePreset>[
  ...
  VoicePreset(id: 'Callirrhoe', name: 'Callirrhoe', description: 'Easy-going - 随和'),
  ...
  VoicePreset(id: 'Rasalgethi', name: 'Rasalgethi', description: 'Informative - 信息丰富'),
  ...
  VoicePreset(id: 'Pulcherrima', name: 'Pulcherrima', description: 'Forward - 直接'),
  VoicePreset(id: 'Achird', name: 'Achird', description: 'Friendly - 友好'),
  VoicePreset(id: 'Zubenelgenubi', name: 'Zubenelgenubi', description: 'Casual - 随意'),
  VoicePreset(id: 'Vindemiatrix', name: 'Vindemiatrix', description: 'Gentle - 温和'),
  VoicePreset(id: 'Sadachbia', name: 'Sadachbia', description: 'Lively - 活泼'),
  VoicePreset(id: 'Sadaltager', name: 'Sadaltager', description: 'Knowledgeable - 博学'),
...
const kMiniMaxVoices = <VoicePreset>[
  VoicePreset(id: 'female-tianmei', name: '甜美女声', description: '甜美温柔的女性声音', language: 'zh'),
  VoicePreset(id: 'female-shaonv', name: '少女', description: '年轻活泼的少女声音', language: 'zh'),
  VoicePreset(id: 'female-yujie', name: '御姐', description: '成熟魅力的女性声音', language: 'zh'),
  VoicePreset(id: 'female-chengshu', name: '成熟女声', description: '稳重大气的女性声音', language: 'zh'),
  VoicePreset(id: 'male-qn-qingse', name: '青涩青年', description: '年轻清新的男性声音', language: 'zh'),
  VoicePreset(id: 'male-qn-jingying', name: '精英青年', description: '专业自信的男性声音', language: 'zh'),
  VoicePreset(id: 'male-qn-badaozongjie', name: '霸道总裁', description: '低沉有磁性的男性声音', language: 'zh'),
  VoicePreset(id: 'male-qn-daxuesheng', name: '大学生', description: '朝气蓬勃的男性声音', language: 'zh'),
  VoicePreset(id: 'presenter_male', name: '男性主持人', description: '专业播音风格男声', language: 'zh'),
  VoicePreset(id: 'presenter_female', name: '女性主持人', description: '专业播音风格女声', language: 'zh'),
  VoicePreset(id: 'Chinese (Mandarin)_Warm_Bestie', name: '温暖闺蜜（粤语兼容）', description: '支持粤语的温暖女声', language: 'yue'),
  VoicePreset(id: 'Cantonese_Female_1', name: '粤语女声1', description: '标准粤语女声', language: 'yue'),
  VoicePreset(id: 'English_Male_1', name: '英语男声', description: '标准英语男声', language: 'en'),
  VoicePreset(id: 'English_Female_1', name: '英语女声', description: '标准英语女声', language: 'en'),
];
...
const kElevenLabsVoices = <VoicePreset>[
  VoicePreset(id: 'JBFqnCBsd6RMkjVDRZzb', name: 'George', description: '温暖的英式男声'),
  ...
  VoicePreset(id: 'onwK4e9ZLuTAKqWW03F9', name: 'Daniel', description: '深沉的英式男声'),
  VoicePreset(id: 'N2lVS1w4EtoT3dr4eOWO', name: 'Callum', description: '年轻的男声'),
  VoicePreset(id: 'XB0fDUnXU5powFXDhCwa', name: 'Charlotte', description: '优雅的女声'),
  VoicePreset(id: 'Xb7hH8MSUJpSbSDYk0k2', name: 'Alice', description: '成熟的女声'),
  VoicePreset(id: 'iP95p4xoKVk53GoZ742B', name: 'Chris', description: '亲切的男性声音'),
  VoicePreset(id: 'cgSgspJ2msm6clMCkdW9', name: 'Jessica', description: '活泼的女声'),
];

const kElevenLabsModels = <VoicePreset>[
  VoicePreset(id: 'eleven_multilingual_v2', name: 'Multilingual v2', description: '多语言高质量模型'),
  VoicePreset(id: 'eleven_turbo_v2_5', name: 'Turbo v2.5', description: '低延迟优化模型'),
  VoicePreset(id: 'eleven_flash_v2_5', name: 'Flash v2.5', description: '超低延迟模型'),
  VoicePreset(id: 'eleven_monolingual_v1', name: 'English v1', description: '英语专用模型'),
];

const kElevenLabsOutputFormats = <VoicePreset>[
  VoicePreset(id: 'mp3_44100_128', name: 'MP3 44.1kHz 128kbps', description: '高质量'),
  VoicePreset(id: 'mp3_44100_64', name: 'MP3 44.1kHz 64kbps', description: '标准质量'),
  VoicePreset(id: 'mp3_22050_32', name: 'MP3 22.05kHz 32kbps', description: '低带宽'),
  ...
  VoicePreset(id: 'pcm_44100', name: 'PCM 44.1kHz', description: '原始 PCM CD 质量'),
...
const kVolcanoEmotionGroups = <String, List<String>>{
  '基础情感': ['happy', 'sad', 'angry', 'scare', 'fear', 'hate', 'surprise', 'tear', 'novel_dialog', 'excited', 'coldness', 'neutral', 'depressed'],
  '交流情感': ['pleased', 'sorry', 'annoyed', 'shy', 'tender'],
  '专业风格': ['customer_service', 'professional', 'serious', 'assistant', 'advertising', 'news', 'entertainment'],
  '叙述风格': ['narrator', 'narrator_immersive', 'storytelling', 'radio', 'chat'],
  '特色风格': ['comfort', 'lovey-dovey', 'energetic', 'conniving', 'tsundere', 'charming', 'yoga', 'tension', 'magnetic', 'vocal-fry', 'asmr', 'dialect'],
