...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,kind,name,enabled,apiKey,baseUrl,model,voice,groupId,emotion,speed,languageBoost,sampleRate,bitrate,audioFormat,region,azureRate,azurePitch,azureVolume,azureStyle,azureStyleDegree,azureRole,azureOutputFormat,voiceName,stylePrompt,useMultiSpeaker,speaker1Name,speaker1Voice,speaker2Name,speaker2Voice,outputFormat,stability,similarityBoost,elStyle,useSpeakerBoost,appId,cluster,apiVersion,resourceId,volume,pitch,encoding,gain,maxTokens,instructions]);
