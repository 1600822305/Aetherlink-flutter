...
mixin _$TtsProviderSetting {
 ...
 String get id; TtsProviderKind get kind; String get name; bool get enabled; String get apiKey; String get baseUrl; String get model; String get voice; String get groupId; String get emotion; double get speed; String get languageBoost; int get sampleRate; int get bitrate; String get audioFormat; String get region; String get voiceName; String get stylePrompt; bool get useMultiSpeaker; String get speaker1Name; String get speaker1Voice; String get speaker2Name; String get speaker2Voice; String get outputFormat; String get appId; String get cluster; String get apiVersion; String get resourceId; double get volume; double get pitch; String get encoding; double get gain; int get maxTokens; String get instructions;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,kind,name,enabled,apiKey,baseUrl,model,voice,groupId,emotion,speed,languageBoost,sampleRate,bitrate,audioFormat,region,voiceName,stylePrompt,useMultiSpeaker,speaker1Name,speaker1Voice,speaker2Name,speaker2Voice,outputFormat,appId,cluster,apiVersion,resourceId,volume,pitch,encoding,gain,maxTokens,instructions]);

@override
String toString() {
  return 'TtsProviderSetting(id: $id, kind: $kind, name: $name, enabled: $enabled, apiKey: $apiKey, baseUrl: $baseUrl, model: $model, voice: $voice, groupId: $groupId, emotion: $emotion, speed: $speed, languageBoost: $languageBoost, sampleRate: $sampleRate, bitrate: $bitrate, audioFormat: $audioFormat, region: $region, voiceName: $voiceName, stylePrompt: $stylePrompt, useMultiSpeaker: $useMultiSpeaker, speaker1Name: $speaker1Name, speaker1Voice: $speaker1Voice, speaker2Name: $speaker2Name, speaker2Voice: $speaker2Voice, outputFormat: $outputFormat, appId: $appId, cluster: $cluster, apiVersion: $apiVersion, resourceId: $resourceId, volume: $volume, pitch: $pitch, encoding: $encoding, gain: $gain, maxTokens: $maxTokens, instructions: $instructions)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  TtsProviderKind kind,  String name,  bool enabled,  String apiKey,  String baseUrl,  String model,  String voice,  String groupId,  String emotion,  double speed,  String languageBoost,  int sampleRate,  int bitrate,  String audioFormat,  String region,  String voiceName,  String stylePrompt,  bool useMultiSpeaker,  String speaker1Name,  String speaker1Voice,  String speaker2Name,  String speaker2Voice,  String outputFormat,  String appId,  String cluster,  String apiVersion,  String resourceId,  double volume,  double pitch,  String encoding,  double gain,  int maxTokens,  String instructions)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TtsProviderSetting() when $default != null:
return $default(_that.id,_that.kind,_that.name,_that.enabled,_that.apiKey,_that.baseUrl,_that.model,_that.voice,_that.groupId,_that.emotion,_that.speed,_that.languageBoost,_that.sampleRate,_that.bitrate,_that.audioFormat,_that.region,_that.voiceName,_that.stylePrompt,_that.useMultiSpeaker,_that.speaker1Name,_that.speaker1Voice,_that.speaker2Name,_that.speaker2Voice,_that.outputFormat,_that.appId,_that.cluster,_that.apiVersion,_that.resourceId,_that.volume,_that.pitch,_that.encoding,_that.gain,_that.maxTokens,_that.instructions);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  TtsProviderKind kind,  String name,  bool enabled,  String apiKey,  String baseUrl,  String model,  String voice,  String groupId,  String emotion,  double speed,  String languageBoost,  int sampleRate,  int bitrate,  String audioFormat,  String region,  String voiceName,  String stylePrompt,  bool useMultiSpeaker,  String speaker1Name,  String speaker1Voice,  String speaker2Name,  String speaker2Voice,  String outputFormat,  String appId,  String cluster,  String apiVersion,  String resourceId,  double volume,  double pitch,  String encoding,  double gain,  int maxTokens,  String instructions)  $default,) {final _that = this;
switch (_that) {
case _TtsProviderSetting():
return $default(_that.id,_that.kind,_that.name,_that.enabled,_that.apiKey,_that.baseUrl,_that.model,_that.voice,_that.groupId,_that.emotion,_that.speed,_that.languageBoost,_that.sampleRate,_that.bitrate,_that.audioFormat,_that.region,_that.voiceName,_that.stylePrompt,_that.useMultiSpeaker,_that.speaker1Name,_that.speaker1Voice,_that.speaker2Name,_that.speaker2Voice,_that.outputFormat,_that.appId,_that.cluster,_that.apiVersion,_that.resourceId,_that.volume,_that.pitch,_that.encoding,_that.gain,_that.maxTokens,_that.instructions);case _:
  throw StateError('Unexpected subclass');
...
class _TtsProviderSetting implements TtsProviderSetting {
  const _TtsProviderSetting({required this.id, required this.kind, this.name = '', this.enabled = false, this.apiKey = '', this.baseUrl = '', this.model = '', this.voice = '', this.groupId = '', this.emotion = '', this.speed = 1.0, this.languageBoost = '', this.sampleRate = 32000, this.bitrate = 128000, this.audioFormat = 'mp3', this.region = '', this.voiceName = '', this.stylePrompt = '', this.useMultiSpeaker = false, this.speaker1Name = '', this.speaker1Voice = '', this.speaker2Name = '', this.speaker2Voice = '', this.outputFormat = '', this.appId = '', this.cluster = '', this.apiVersion = 'auto', this.resourceId = '', this.volume = 1.0, this.pitch = 1.0, this.encoding = 'mp3', this.gain = 0.0, this.maxTokens = 1600, this.instructions = ''});
